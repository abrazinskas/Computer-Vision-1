...
%   n2 : width of the neihbourhood for finding local maximum (disabled)
...
function [H,r,c,cm] = harris(img, n1, th, sigma,to_plot)

    error(nargchk(4,5,nargin)); % expect 5 or 6 arguments
    ...
    cm =H>th; %& findLocalMaximum(H,n2); (disabled to gain a speedup)
